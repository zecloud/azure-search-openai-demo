                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Parlez avec vos données</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Demandez moi n'importe quoi ou essayez un exemple</h2>
